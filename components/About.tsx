        ...
        <div className="space-y-4 text-slate-600 leading-relaxed text-lg">
          <p>
            {lang === 'es'
              ...
              : 'Graduated in Commerce with a Master’s Degree in International Business and Foreign Trade, Pablo Lorenzo is a 22-year-old professional with experience in international purchasing and global logistics within the industrial and naval sectors. If I had to define myself personally, I would say I am a hardworking, conscious individual who thrives on challenges.'}
          </p>
          <p>
            {lang === 'es'
              ...
              : 'Through my professional experience, I have worked with international suppliers and coordinated supply and procurement operations across diverse markets, particularly supporting fleet operations in South Africa and Namibia. Having worked throughout the year at Iberconsa, my passion for international business grows stronger, and I have hands-on knowledge of how purchasing, logistics, and global trade integrate smoothly.'}
          </p>
          <p>
            {lang === 'es'
              ...
              : 'With an advanced C1.1 level of English, I am eager to continue expanding my career in an international environment, taking on new responsibilities and leveraging my expertise in international purchasing, foreign trade, supply chain management, and B2B business development.'}
          </p>
        </div>
