    ...
    <footer className="bg-slate-950 text-white py-16">
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm max-w-xs leading-relaxed">
              {lang === 'es'
                ...
                : 'Dedicated to excellence in international trade and value creation across global markets.'}
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-slate-300">
              ...
              <li className="flex items-center">
                ...
                <span>{lang === 'es' ? 'A Coruña, Galicia, España' : 'A Coruña, Galicia, Spain'}</span>
              </li>
            </ul>
          </div>
          <div>
        ...
        <div className="pt-8 border-t border-white/5 text-center text-slate-500 text-xs">
          © {new Date().getFullYear()} Pablo Lorenzo Alonso. {lang === 'es' ? 'Todos los derechos reservados.' : 'All rights reserved.'}
        </div>
      </div>
    </footer>
  );
